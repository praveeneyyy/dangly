...
| [`Dangly-Windows.zip`](file:///c:/Projects/Dangly/github/Dangly-Windows.zip) | Windows | Complete standalone portable zip with all assets, sounds, and DLLs (~7.10 MB) |
...
| [`Dangly-macOS.zip`](file:///c:/Projects/Dangly/github/Dangly-macOS.zip) | macOS | Complete native Apple Silicon project bundle with assets (~10.6 MB) |
...
| **Full-Screen Stretch** | Drag the charm anywhere across the full width and height of the display |
| **Snap & Recoil** | Release mouse to trigger elastic snap-back and physics oscillations to anchor resting position |
